    ...
    { headerName: 'Rez. url.', field: 'VacRes', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 80, suppressMenu: true, agr: 'sum', 
      ...
      { headerName: 'Koszty klient',
        children: [
          ...
          { headerName: 'Dod.nie brutto', headerTooltip: 'Dodatkowe składniki niewchodzące do brutto', field: 'AdditionCustOther', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 100, suppressMenu: true, agr: 'sum', columnGroupShow: "open", sortable: true, resizable: true,
            renderType: 'number',
            cellClass: ['font11','numberFormat2Dec'],
          },            
