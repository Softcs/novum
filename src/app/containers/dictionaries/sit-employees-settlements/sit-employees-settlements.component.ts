...
export class SitEmployeesSettlementsComponent extends SitDictBaseComponent {
  ...
  public prepareColumnsDefinitnion() {
    ...
    this.gridColumnsDefinition['sitEmployeesSettlementsContr'] = [
      ...
      { headerName: 'Dni',
        children: [
          { headerName: 'Umowy', field: 'ContractDays', headerTooltip:'Dni umowy', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 80, suppressMenu: true, agr: 'sum',
            renderType: 'number', renderFormat: '1.0-0',
            cellClass: ['font11','numberFormat2Dec'],
          },
          { headerName: 'Rob. z um.', field: 'NominalDays',headerTooltip: 'Dni robocze z umowy', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 80, suppressMenu: true, agr: 'sum',
            renderType: 'number', renderFormat: '1.0-0',
            cellClass: ['font11','numberFormat2Dec'],
          },
          { headerName: 'Przpr.', field: 'WorkDays',headerTooltip:'Dni przepracowane', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 80, suppressMenu: true, agr: 'sum',
            renderType: 'number', renderFormat: '1.0-0',
            cellClass: ['font11','numberFormat2Dec'],
          },
          { headerName: 'Urlopu', field: 'VacDays', headerTooltip: 'Dni urlopu wypoczynkowego', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 80, suppressMenu: true, agr: 'sum',
            renderType: 'number', renderFormat: '1.0-0',
            cellClass: ['font11','numberFormat2Dec'],
          },
          { headerName: 'Url. dod.', field: 'VacDaysAdd', headerTooltip: 'Dni urlopu dodatkowego', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 80, suppressMenu: true, agr: 'sum',
            renderType: 'number', renderFormat: '1.0-0',
            cellClass: ['font11','numberFormat2Dec'],
          },
          { headerName: 'Chor.', field: 'SickDays', headerTooltip: 'Dni chorobowego', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 80, suppressMenu: true, agr: 'sum',
            renderType: 'number', renderFormat: '1.0-0',
            cellClass: ['font11','numberFormat2Dec'],
          },
        ]
      ...
      children: [
        ...
        { headerName: 'Nominalne', field: 'Base', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 90, suppressMenu: true, agr: 'sum',columnGroupShow: "open",
          renderType: 'number', renderFormat: '1.2-2',
          cellClass: ['font11','numberFormat2Dec'],
        },
        ...
        { headerName: 'Postojowe', field: 'ParkingPay', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 90, suppressMenu: true, columnGroupShow: "open", agr: 'sum',
          renderType: 'number', renderFormat: '1.2-2',
          cellClass: ['font11','numberFormat2Dec'],
        },
        { headerName: 'Ekw. url.', field: 'EquivPay', headerTooltip:'Ekwiwalent urlopowy', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 90, suppressMenu: true, columnGroupShow: "open", agr: 'sum',
          renderType: 'number', renderFormat: '1.2-2',
          cellClass: ['font11','numberFormat2Dec'],
        },
        { headerName: 'Wyr. brutto', field: 'EqualPay', headerTooltip:'Wyrównanie brutto', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 90, suppressMenu: true, columnGroupShow: "open", agr: 'sum',
          renderType: 'number', renderFormat: '1.2-2',
          cellClass: ['font11','numberFormat2Dec'],
        },
        { headerName: 'Wyr. do min.', field: 'ToMinPay', headerTooltip:'Wyrównanie do minimalnej', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 100, suppressMenu: true, columnGroupShow: "open", agr: 'sum',
          renderType: 'number', renderFormat: '1.2-2',
          cellClass: ['font11','numberFormat2Dec'],
        },
        ...
        { headerName: 'Dof.zakw.', headerTooltip: 'Dofinansowanie do zakwaterowania', field: 'Addition01', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 100, suppressMenu: true, agr: 'sum', columnGroupShow: "open",
          renderType: 'number',
          cellClass: ['font11','numberFormat2Dec'],
        },            
        { headerName: 'Dof.posił.', headerTooltip: 'Dofinansowanie do posiłków', field: 'Addition02', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 100, suppressMenu: true, agr: 'sum', columnGroupShow: "open",
          renderType: 'number',
          cellClass: ['font11','numberFormat2Dec'],
        }, 
        { headerName: 'Dof.posił.bez ZUS', headerTooltip: 'Dofinansowanie do posiłków bez ZUS', field: 'Addition04', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 100, suppressMenu: true, agr: 'sum', columnGroupShow: "open",
          renderType: 'number',
          cellClass: ['font11','numberFormat2Dec'],
        },    
        { headerName: 'Nagr.rzecz/Bony', headerTooltip: 'Nagrody rzeczowe i bony', field: 'Vouchers', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 80, suppressMenu: true, agr: 'sum', columnGroupShow: "open",
          renderType: 'number',
          cellClass: ['font11','numberFormat2Dec'],
        },                  
        { headerName: 'Dof.do ubezp.', headerTooltip: 'Dofinansowanie do ubezpieczenia', field: 'Addition05', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 100, suppressMenu: true, agr: 'sum', columnGroupShow: "open",
          renderType: 'number',
          cellClass: ['font11','numberFormat2Dec'],
        },
        { headerName: 'Dof.med.', headerTooltip: 'Dofinansowanie do opieki medycznej', field: 'Addition06', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 100, suppressMenu: true, agr: 'sum', columnGroupShow: "open",
          renderType: 'number',
          cellClass: ['font11','numberFormat2Dec'],
        },         
        { headerName: 'Zwroty', headerTooltip: 'Zwroty za badania lekarskie, okulary, delegacje do posiłków', field: 'Addition03', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 100, suppressMenu: true, agr: 'sum', columnGroupShow: "open",
          renderType: 'number',
          cellClass: ['font11','numberFormat2Dec'],
        },
        { headerName: 'Odprawy', headerTooltip: 'Odprawy', field: 'Addition07', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 100, suppressMenu: true, agr: 'sum', columnGroupShow: "open",
          renderType: 'number',
          cellClass: ['font11','numberFormat2Dec'],
        },                  
        { headerName: 'Dodatki inne', headerTooltip: 'Dodatkowe składniki inne', field: 'Additions', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 100, suppressMenu: true, agr: 'sum', columnGroupShow: "open",
          renderType: 'number',
          cellClass: ['font11','numberFormat2Dec'],
        },            
    ...
    { headerName: 'Rez. url.', field: 'VacRes', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 80, suppressMenu: true, agr: 'sum', 
      ...
      { headerName: 'Koszty klient',
        children: [
          ...
          { headerName: 'Postojowe', field: 'CustRate10', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 90, suppressMenu: true, columnGroupShow: "open", agr: 'sum',
            renderType: 'number', renderFormat: '1.2-2',
            cellClass: ['font11','numberFormat2Dec'],
          },
          { headerName: 'Ekw. url.', field: 'CustRate11', headerTooltip:'Ekwiwalent urlopowy', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 90, suppressMenu: true, columnGroupShow: "open", agr: 'sum',
            renderType: 'number', renderFormat: '1.2-2',
            cellClass: ['font11','numberFormat2Dec'],
          },
          { headerName: 'Wyr. brutto', field: 'CustRate12', headerTooltip:'Wyrównanie brutto', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 90, suppressMenu: true, columnGroupShow: "open", agr: 'sum',
            renderType: 'number', renderFormat: '1.2-2',
            cellClass: ['font11','numberFormat2Dec'],
          },
          { headerName: 'Wyr. do min.', field: 'CustRate13', headerTooltip:'Wyrównanie do minimalnej', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 100, suppressMenu: true, columnGroupShow: "open", agr: 'sum',
            renderType: 'number', renderFormat: '1.2-2',
            cellClass: ['font11','numberFormat2Dec'],
          },
          ...
          { headerName: 'Dof.zakw.', headerTooltip: 'Dofinansowanie do zakwaterowania', field: 'AdditionCust01', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 100, suppressMenu: true, agr: 'sum', columnGroupShow: "open",
            renderType: 'number',
            cellClass: ['font11','numberFormat2Dec'],
          },            
          { headerName: 'Odprawy', headerTooltip: 'Odprawy', field: 'AdditionCust07', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 100, suppressMenu: true, agr: 'sum', columnGroupShow: "open",
            renderType: 'number',
            cellClass: ['font11','numberFormat2Dec'],
          },            
          { headerName: 'Dodatki inne', headerTooltip: 'Dodatkowe składniki inne', field: 'AdditionsCust', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 100, suppressMenu: true, agr: 'sum', columnGroupShow: "open",
            renderType: 'number',
           cellClass: ['font11','numberFormat2Dec'],
          },                      
          ...
          { headerName: 'Nagr.rzecz/Bony', headerTooltip: 'Nagrody rzeczowe i bony', field: 'VouchersCust', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 80, suppressMenu: true, agr: 'sum', columnGroupShow: "open",
            renderType: 'number',
            cellClass: ['font11','numberFormat2Dec'],
          },
          { headerName: 'Bad.lek.', headerTooltip: 'Zwroty za badania, okulary', field: 'AdditionCust03', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 90, suppressMenu: true, agr: 'sum', columnGroupShow: 'open',
            renderType: 'number',
            cellClass: ['font11','numberFormat2Dec'],
          },
