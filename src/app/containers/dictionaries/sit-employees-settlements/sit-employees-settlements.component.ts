    ...
    { headerName: 'Rez. url.', field: 'VacRes', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 80, suppressMenu: true, agr: 'sum', 
      ...
      { headerName: 'Koszty klient',
        children: [
          ...
          { headerName: 'Bony', headerTooltip: 'Bony', field: 'Vouchers', filter: 'agNumberColumnFilter', type: 'numericColumn', width: 80, suppressMenu: true, agr: 'sum', columnGroupShow: "open",
            renderType: 'number',
            cellClass: ['font11','numberFormat2Dec'],
          },
