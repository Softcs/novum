  ...
  public prepareColumnsDefinitnion() {
    this.gridColumnsDefinition["sitCashFlow"] = [
      ...
      { headerName: 'Płatnik', field: 'AddGroupIdent', filter: 'agTextColumnFilter', width: 100,
        enableRowGroup: true, rowGroup: true, hide: true },
      { headerName: 'Kontrahent', field: 'CustIdent_Payer', filter: 'agTextColumnFilter', minWidth: 100, maxWidth: 150, defaultVisibility: false, },
      { headerName: 'Nazwa kontrahenta', field: 'CustName_Payer', filter: 'agTextColumnFilter', width: 100, defaultVisibility: false, },
