...
export class SitWarehousesComponent extends SitDictBaseComponent {
  public prepareColumnsDefinitnion() {
    this.gridColumnsDefinition["sitWarehouses"] = [
      { headerName: 'sitWarehousesId', field: 'sitWarehousesId', type: 'numericColumn', sortable: true, filter: 'agNumberColumnFilter', defaultVisiblity: false},
      { headerName: 'sitWarehousesG', field: 'sitWarehousesG', filter: 'agTextColumnFilter', defaultVisiblity: false },
