...
export class SitCustomersComponent extends SitDictBaseComponent {
   public prepareColumnsDefinitnion() {
    ...
    this.gridColumnsDefinition["sitCustomerEDocs"] = [
      ...
      { headerName: 'Dekl. xml', field: 'XmlFileAddDeclaration', width: 100, renderType: 'checkbox', suppressMenu: true, cellClass: "grid-cell-centered"},
      { headerName: 'Kodowanie', field: 'XmlFileCodePage', width: 130, },
    ...
    this.gridColumnsDefinition["sitHRParams4InvoicingContr"] = [
      ...
      { headerName: 'ZUS Emer.', headerTooltip:'Licz inną stawkę ZUS dla emerytów', field: 'CalcZUS4Pens', filter: 'agSetColumnFilter', cellClass: "grid-cell-centered", suppressMenu: true, width: 70, renderType: "checkbox"},
