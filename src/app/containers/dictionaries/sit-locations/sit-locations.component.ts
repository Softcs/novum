...
export class SitLocationsComponent extends SitDictBaseComponent {
   public prepareColumnsDefinitnion() {
    this.gridColumnsDefinition["sitLocations"] = [
      { headerName: 'Id', field: 'sitLocationsId', type: 'numericColumn', filter: 'agTextColumnFilter', width: 50, defaultVisibility: false },
      { headerName: 'GUID', field: 'sitLocationsG', filter: 'agTextColumnFilter', width: 100, defaultVisibility: false },
