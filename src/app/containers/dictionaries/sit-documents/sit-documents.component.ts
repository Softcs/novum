...
export class SitDocumentsComponent extends SitDictBaseComponent {
  public prepareColumnsDefinitnion() {
      this.gridColumnsDefinition["sitDocumentsHeaders"] = [
        ...
        { headerName: 'Netto wl', field: 'NetCurrency', filter: 'agTextColumnFilter', type: 'numericColumn', suppressMenu: true, width: 80, defaultVisibility: false },
        { headerName: 'Vat wl', field: 'VATCurrency', filter: 'agTextColumnFilter', type: 'numericColumn', suppressMenu: true, width: 80, defaultVisibility: false },
        { headerName: 'Brutto wl', field: 'GrossCurrency', filter: 'agTextColumnFilter', type: 'numericColumn', suppressMenu: true, width: 80, defaultVisibility: false },   
      ...
      this.gridColumnsDefinition["sitDocumentsPositions"] = [
        ...
        { headerName: 'Ilość', field: 'QuantityUnit', filter: 'agNumberColumnFilter', type: 'numericColumn', suppressMenu: true, width: 60 },
        { headerName: 'Cena', field: 'Price', filter: 'agTextColumnFilter', type: 'numericColumn', suppressMenu: true, width: 80, defaultVisibility: false },
        { headerName: 'Rabat %', field: 'DiscountProcent', filter: 'agTextColumnFilter', type: 'numericColumn', suppressMenu: true, width: 80, defaultVisibility: false },
        { headerName: 'Rabat kw.', field: 'DiscountAmount', filter: 'agTextColumnFilter', type: 'numericColumn', suppressMenu: true, width: 80, defaultVisibility: false },
        { headerName: 'Cena po rab.', field: 'PriceAfterDiscount', filter: 'agTextColumnFilter', type: 'numericColumn', suppressMenu: true, width: 80 },
