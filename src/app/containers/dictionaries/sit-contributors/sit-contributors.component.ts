...
// console.log('params.data: ', params.data);
    ...
    this.gridColumnsDefinition["sitContributorAlternativeNames"] = [
      ...
      { headerName: 'Używaj danych autora', field: 'ShowContributorName', filter: 'agSetColumnFilter', width: 150, renderType: 'checkbox', suppressMenu: true, cellClass: "grid-cell-centered", defaultVisibility: true },
      { headerName: 'Dane autora pierwsze', field: 'ContributorNameFirst', filter: 'agSetColumnFilter', width: 150, renderType: 'checkbox', suppressMenu: true, cellClass: "grid-cell-centered", defaultVisibility: true },
    ];    
  }
