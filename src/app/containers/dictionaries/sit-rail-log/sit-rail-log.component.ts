...
export class SitRailLogComponent extends SitDictBaseComponent {
  ...
  public prepareColumnsDefinitnion() {
    this.gridColumnsDefinition["sitRailLog"] = [
      ...
      { headerName: 'MaxLogDate', field: 'MaxLogDate', type: 'numericColumn', filter: 'agDateColumnFilter', width: 140,
      renderType: "date", renderFormat: "yyyy-MM-dd H:mm:ss" },
      { headerName: 'MinLogDate', field: 'MinLogDate', type: 'numericColumn', filter: 'agDateColumnFilter', width: 140,
      renderType: "date", renderFormat: "yyyy-MM-dd H:mm:ss"},
    ...
    this.gridColumnsDefinition["sitRailLogDetails"] = [
      ...
      { headerName: 'LogDate', field: 'LogDate', type: 'numericColumn', filter: 'agDateColumnFilter', width: 140, sort: 'desc',
      renderType: "date", renderFormat: "yyyy-MM-dd H:mm:ss" },
